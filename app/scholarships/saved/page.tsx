    ...
    return (
      <div className="min-h-screen" style={{ background: 'var(--background)' }}>
        ...
        <div className="max-w-[1600px] mx-auto px-6 py-20 text-center">
          ...
          <p style={{ color: 'var(--muted)' }}>Loading saved scholarships...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: 'var(--muted)' }}>
                {counts.saved} scholarships saved for later
              </p>
            </div>
        ...
        {scholarships.length === 0 ? (
          ...
          >
            ...
            <p style={{ color: 'var(--muted)' }}>
              Save scholarships from the All Scholarships page to access them here
            </p>
          </div>
        ) : (
          <div
